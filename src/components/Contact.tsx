const links = [
  {
    label: 'Email',
    href: 'mailto:ejkennedy@proton.me',
    icon: (
  ...
  {
    label: 'LinkedIn',
    href: 'https://linkedin.com/in/ejkennedy',
    icon: (
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="1" y="1" width="16" height="16" rx="3" stroke="currentColor" stroke-width="1.5"/>
        <path d="M5 7v6M5 5v.01M9 13v-3a2 2 0 014 0v3M9 7v6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
      </svg>
    ),
  },
  {
      ...
      <div class="reveal relative rounded-card overflow-hidden border border-white/[0.08] bg-surface text-center px-8 py-20">
        ...
        <div class="relative z-10 flex flex-col items-center gap-8">
          ...
          <p class="text-secondary max-w-md text-[17px] leading-relaxed">
            Open to ML engineering roles, interesting freelance projects, and research collaborations.
          </p>
